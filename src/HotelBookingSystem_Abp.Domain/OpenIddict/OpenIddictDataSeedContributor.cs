...
namespace HotelBookingSystem_Abp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("HotelBookingSystem_Abp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "HotelBookingSystem_Abp", DisplayName = "HotelBookingSystem_Abp API", Resources = { "HotelBookingSystem_Abp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["HotelBookingSystem_Abp_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["HotelBookingSystem_Abp_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["HotelBookingSystem_Abp_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["HotelBookingSystem_Abp_Swagger:RootUrl"]?.TrimEnd('/');
